...
export const platformModules: PlatformModule[] = [
  ...
  {
    title: "Risk-Based Workload & AI Agents",
    code: "WORKFLOW",
    icon: Bot,
    summary:
      "Automatically routes remediation work to the right owners and continuously re-prioritizes initiatives by live business risk.",
    lifecycle: ["Categorize work", "Assign owners", "Re-rank initiatives", "Align to impact"],
  },
  {
  ...
  },
  {
    ...
    icon: ShieldCheck,
    summary:
      "Maps 3,000+ controls across ISO 27001, NIST CSF, FAIR, CIS, COBIT, CSA CCM, SCF, and custom client libraries.",
    lifecycle: ["Map controls", "Collect evidence", "Monitor effectiveness", "Stay audit ready"],
  },
  {
    ...
    icon: Gauge,
    summary:
      "Delivers an end-to-end risk lifecycle across identification, assessment, prioritization, treatment, monitoring, and reporting.",
    lifecycle: ["Identify", "Assess", "Prioritize", "Treat"],
  },
  {
  ...
  },
  {
    ...
    icon: Workflow,
    summary:
      "Provides ITIL-aligned change and project governance with approval views, delivery dashboards, budget tracking, and audit history.",
    lifecycle: ["Request", "Assess", "Approve", "Monitor"],
  },
  {
    title: "Issue Management & Assessments",
    code: "ISSUE_MGMT",
    icon: ClipboardCheck,
    summary:
      "Plans assessments, assigns owners and reviewers, tracks aging, and uses AI triggers to create high-priority assessment work.",
    lifecycle: ["Plan scope", "Assign reviewers", "Execute checks", "Track aging"],
  },
  {
    title: "Human Risk",
    code: "HUMAN_RISK",
